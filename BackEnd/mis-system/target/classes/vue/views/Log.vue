  ...
  <div class="app-container">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="100px">
          ...
          <el-form-item label="目标对象" prop="target">
            <el-input v-model="queryParams.target" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="方法名称" prop="method">
            <el-input v-model="queryParams.method" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="业务类型" prop="businessType">
            <el-input v-model="queryParams.businessType" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="请求方式" prop="requestMethod">
            <el-input v-model="queryParams.requestMethod" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="请求url" prop="requestUrl">
            <el-input v-model="queryParams.requestUrl" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="请求结果编码" prop="resultCode">
            <el-input v-model="queryParams.resultCode" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="请求者" prop="requestBy">
            <el-input v-model="queryParams.requestBy" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="请求时间" prop="requestTime">
            <el-input v-model="queryParams.requestTime" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <!-- 数据筛选操作按钮 -->
          <el-form-item>
        ...
        <el-table v-loading="loading" :data="logList">
          ...
          <el-table-column label="请求结果编码" align="center" prop="resultCode" />
          <el-table-column label="请求者" align="center" prop="requestBy" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="目标对象" prop="target">
          <el-input v-model="form.target" placeholder="请输入目标对象" />
        </el-form-item>
        <el-form-item label="方法名称" prop="method">
        ...
        <el-form-item label="请求结果编码" prop="resultCode">
          <el-input v-model="form.resultCode" placeholder="请输入请求结果编码" />
        </el-form-item>
        <el-form-item label="请求者" prop="requestBy">
          <el-input v-model="form.requestBy" placeholder="请输入请求者" />
        </el-form-item>
        <el-form-item label="请求时间" prop="requestTime">
...
<script>
/** 导入axios Api */
import { listLogByPage, getLog, addLog, updateLog, deleteLog } from '@/api/log'
export default {
  name: 'Log',
  data() {
    return {
