      ...
      <el-col :span="24" :xs="24">
        ...
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="100px">
          ...
          <el-form-item label="角色名称" prop="roleName">
            <el-input v-model="queryParams.roleName" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="角色权限字符串" prop="roleKey">
            <el-input v-model="queryParams.roleKey" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="显示顺序" prop="roleSort">
            <el-input v-model="queryParams.roleSort" placehold clearable size="small" @keyup.enter.native="handleQuery" />
          </el-form-item>
...
<script>
/** 导入axios Api */
import { listByPage, get, add, update, delete } from '@/api/'
export default {
  name: '',
  data() {
    return {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listByPage(this.queryParams).then((response) => {
